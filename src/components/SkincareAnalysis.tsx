  ...
  return (
    <>
      <section className="sm:container relative flex flex-wrap-reverse w-full h-max px-0 sm:px-8 mt-20 lg:mt-14">
        ...
        >
          <h3 className="hidden lg:inline-block skincare-analysis__title  text-white font-bold">
            NEW Virtual Skincare Analysis
          </h3>
          <p className="skincare-analysis__text lg:font-extralight text-black lg:text-white mt-6 lg:m-0">
          ...
          <p className="hidden lg:inline-block skincare-analysis__title-second font-bold text-white">
            Scan with your phone to get started
          </p>
          <p className="hidden lg:inline-block skincare-analysis__text font-extralight text-white">
            Or
          </p>
          <div className="flex gap-x-4 w-full">
            ...
            <button className="w-1/2 lg:hidden text-white skincare-analysis__button-text lg:capitalize bg-primary-500 lg:px-8 py-2">
              take a selfie
            </button>
          </div>
          <img
