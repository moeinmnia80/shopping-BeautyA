...
const SpecialOffers: FC = () => {
  return (
    <>
      <section className="lg:container relative flex flex-col md:flex-row items-center justify-center gap-6 pt-14 md:pt-0">
        ...
        <div className="flex flex-col gap-y-3 md:gap-2 w-full md:w-1/2 px-8 md:p-0">
