...
const OurBrand = () => {
  return (
    <>
      <section className="lg:container relative flex flex-col-reverse md:flex-row md:bg-primary-750 my-14">
        <div className="flex flex-col items-start justify-center gap-3 text-white px-8 sm:px-0 md:pl-24 md:py-8 md:pr-10">
